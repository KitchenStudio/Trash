...
import com.example.xiner.trash.adapter.CheckingAdapter;
...
public class Checkingfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_checkingfragment, container, false);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerView_checking);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity());
        mRecyclerView.setLayoutManager(mLayoutManager);

        checkingAdapter = new CheckingAdapter(getActivity());
        mRecyclerView.setAdapter(checkingAdapter);
        return view;
    }
