...
import com.example.xiner.trash.fragment.Checkingfragment;
import com.example.xiner.trash.fragment.Deletefragment;
import com.example.xiner.trash.fragment.MyReleasefragment;
...
//        View person = inflater.inflate(R.layout.tab_person,null);
        ...
        mTabsAdapter.addTab(mTabHost.newTabSpec("simple").setIndicator("已发布"),
                MyReleasefragment.class, null);
        mTabsAdapter.addTab(mTabHost.newTabSpec("contacts").setIndicator("审核中"),
