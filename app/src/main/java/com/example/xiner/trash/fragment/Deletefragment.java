...
import com.example.xiner.trash.adapter.DeleteAdapter;
...
public class Deletefragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_deletefragment, container, false);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerView_delete);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity());
        mRecyclerView.setLayoutManager(mLayoutManager);

        deleteAdapter = new DeleteAdapter(getActivity());
        mRecyclerView.setAdapter(deleteAdapter);
        return view;
    }
